...
aim_dir = os.path.dirname(current_file_path)
sys.path.append(aim_dir)

# Add DP3 path for utilities
policy_dir = os.path.dirname(aim_dir)
...
class TrainAIMWorkspace:
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # configure model
        print(">>> [Init] Instantiating Model (AIM Policy)...")
...
@hydra.main(config_path="config", config_name="aim_policy", version_base="1.2")
def main(cfg):
    workspace = TrainAIMWorkspace(cfg)
    workspace.run()
